...
RSpec.describe StudentsController, type: :controller do
  ...
  let(:valid_attributes) {
   # {first_name: "mahesh", last_name: "mane", mark: 600}
    #skip("Add a hash of attributes valid for your model")

        # student = Student.new
        # student.first_name = "Madan"
        # student.last_name = "Mohan"
        # student.mark = 100
  }
  ...
  describe "GET #index" do
    it "assigns all students as @students" do
      student = Student.find(1)#create!valid_attributes
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Student" do
        expect {
          post :create, {:student =>{:first_name => "manish", :last_name => "M", :mark =>550}}#{:student => valid_attributes}, valid_session
        }.to change(Student, :count).by(1)
      end

      it "assigns a newly created student as @student" do
        post :create, {:student => {:first_name => "manish", :last_name => "M", :mark =>550}}, valid_session
    ...
    #     post :create, {:student => {:first_name => "", :last_name => "", :city => ""}}#invalid_attributes}, valid_session
    #     expect(assigns(:student)).to be_a_new(Student)
    #   end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      #   student = Student.create(:first_name => "manish", :last_name => "M", :mark =>550)  # valid_attributes
      #   put :update, {:id => student.to_param, :student => {:first_name => "manish"}}#new_attributes}, valid_session
      #   student.reload
      ...
      it "assigns the requested student as @student" do
        student = Student.create#! valid_attributes
        put :update, {:id => student.to_param, :student => {:first_name => "aaa"}} #valid_attributes}, valid_session
        expect(assigns(:student)).to eq(student)
      end
